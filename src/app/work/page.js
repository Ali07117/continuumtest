  ...
  return (
    ...
    <Navbar/>
      ...
      <div className=" work-anime-container  flex min-h-[100vh]">
        ...
        {/* <div className='absolute workimg opacity-0 workimg1'>       
            <img className='h-[90vh] w-[100%] object-cover rounded-[2.5rem]' src="/images/heroimg1.svg" alt="" />
        </div>
        <div className='absolute workimg opacity-0 workimg2'>
            <img className='h-[90vh] w-[100%] object-cover rounded-[2.5rem]' src="/images/section1img.svg" alt="" />
        </div>
        <div className='absolute workimg opacity-0 workimg3'>
            <img className='h-[90vh] w-[100%] object-cover rounded-[2.5rem]' src="/images/section2img.svg" alt="" />
        </div>
        <div className='absolute workimg opacity-0 workimg3'>
            <img className='h-[90vh] w-[100%] object-cover rounded-[2.5rem]' src="/images/section1img.svg" alt="" />
        </div>
