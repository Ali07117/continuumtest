  ...
  return (
    <>
      <div className="wrapper work-left-text-card-wrapper h-[100vh] pt-[10vh]">
        ...
        <Link href={`${props.pageurl}`}><div className="z-[3]  flex-col min-h-[46px] max-h-[46px] work-button flex items-center border-[2px] border-[#B0B0B0] flex-col min-w-[190px] max-w-[220px] bg-[#00259C] mt-[1.5rem]  text-[white] relative overflow-hidden rounded-[32px] text-[18px] cursor-pointer">
         <div className='  py-[0.5rem] px-[1.5rem] min-h-[50px] max-h-[50px] w-[150%] text-center layer-1 rounded-[32px] text-[1.1rem]  text-[--textprimary] font-[300] font-inter bg-[--bgprimary]'>{props.linktext}</div>
         <div className='  py-[0.5rem] px-[1.5rem] min-h-[50px] max-h-[50px] w-[150%] text-center layer-2 rounded-[32px] text-[1.1rem]  text-[--textsecondry] font-[300] font-inter bg-[#D5D9E4]'>{props.linktext}</div>
        </div></Link>
      </div>
    </>
  );
