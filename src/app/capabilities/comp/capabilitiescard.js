...
function Capabilitiescard(props) {
  return (
    <>
        <div className="capabilities-card-wrapper scrollnone overflow-y-auto capabilities-cards absolute min-h-[80%] max-h-[100%] bg-[#D5D9E4] rounded-[2.5rem] py-[3rem] px-[2rem]">
