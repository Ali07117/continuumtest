...
tl.to(".anime-headingd", {
  ...
  return (
    ...
    <div className="capabilities-anime-container w-[100%] py-[2.2rem] flex min-h-[100vh] mt-[6rem]">
      ...
      <div className="capabilities-right w-[50%] h-[90%]">
