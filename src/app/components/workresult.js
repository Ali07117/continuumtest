...
function WorkResult() {
  ...
  return (
    <>
        ...
        <div className="">
        <p className='text-[2rem] font-[300] automation-animation-16 font-average'>Results </p>
        <p className='text-[20px] work-result-para automation-animation-17 font-inter mt-[1rem] text-[--textsecondry]'>The revamped mobile app significantly improved user satisfaction, addressing core usability issues and enhancing mobile-specific functionality. With clearer navigation and optimized performance, the app became a more effective tool for managing bots and automations, allowing users to stay connected and in control even when away from their desktops.</p>
    </div>
        </div>
        <div className="work-result-right automation-animation-18 w-[50%]">
