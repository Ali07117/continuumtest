...
function SolutionSection(props) {
  ...
  return (
    ...
    <div className="solution-section-left afious-animation-1 w-[50%] " style={{paddingRight:`${props.pr}`}}>
    ...
    <div>
    <p className='text-[2rem] afious-animation-2 font-[300] font-average mt-[4rem]'>{props.heading}</p>
    <p className='text-[20px] afious-animation-3 challenge-container-para font-inter mt-[1rem] text-[--textsecondry]'>{props.subheading}</p>
    </div>
    </div>
    </div>
