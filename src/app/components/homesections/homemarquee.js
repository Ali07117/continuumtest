    ...
    <>
      <div className={`px-[1.5rem] py-[6rem] marquee-wrapper overflow-x-hidden`} style={{ backgroundColor: `${props.bgwrapper}` }}>
        ...
        <div className={`marquee-container my-[1rem] sm:mt-[3rem] flex gap-[55%] overflow-hidden`} style={{ backgroundColor: `${props.bg}` }}>
          ...
          <Marquee style={{}}>
            <img className='ml-[70px]' src="/images/marqueelogo1.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo2.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo3.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo4.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo5.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo1.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo2.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo3.svg" alt="" />
            <img className='ml-[70px]' src="/images/marqueelogo4.svg" alt="" />
