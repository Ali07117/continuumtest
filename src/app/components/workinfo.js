...
function WorkInfo() {
  return (
    ...
    <p className='font-inter workprocess-img-text font-[400] text-[18px] mt-[0.5rem] text-[--textsecondry]'>Process to redesign the app</p>
    </div>
