...
useEffect(() => { 
  ...
  return (
    ...
    <div className="h-[12rem] bg-[white]"></div>
        ...
        {/* <div className="other-work-upper text-[red]">ss</div>   */}
        <div className={` ${props.classtops} min-h-[105px] z-[9] w-[100%] text-[white] sticky bottom-[0] flex items-center justify-center gap-[1rem]`} style={{backgroundColor:"black"}}>
        ...
        <div className={` other-work-top z-[999] min-h-[105px] w-[100%] text-[#00259C] sticky bottom-[0] flex items-center justify-center gap-[1rem]`} style={{backgroundColor:"#D5D9E4"}}>
            <p className=' font-average other-work-top-text text-[3rem]'>Ready to bring your project to life?</p>
            <Link href="/contact"><button className='bg-[#00259C] text-[18px] other-work-top-button text-[white] font-[400] border-[2px] border-[#044AFF] px-[3rem] py-[13px] rounded-[2rem]'>Contact Us</button></Link>
        </div>
