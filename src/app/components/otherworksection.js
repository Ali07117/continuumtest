...
function OtherWorkSection() {
  return (
    ...
    {/* <div className="other-work-top h-[13vh] w-[100%] bg-[#D5D9E4] flex items-center justify-center gap-[1rem]">
        ...
        <div className="other-work-top h-[105px] w-[100%] text-[#00259C] sticky bottom-[0] bg-[#D5D9E4] flex items-center justify-center gap-[1rem]">
            <p className=' font-average text-[3rem]'>Ready to bring your project to life?</p>
            <button className='bg-[#00259C] text-[18px] text-[white] font-[400] border-[2px] border-[#044AFF] px-[3rem] py-[13px] rounded-[2rem]'>Contact Us</button>
        </div>
        <div className='px-[1.5rem] pt-[6rem]'>
    <Footernav/>
        </div>
    </div>
